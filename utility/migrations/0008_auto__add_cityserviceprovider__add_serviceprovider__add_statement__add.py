...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CityServiceProvider'
        db.create_table(u'utility_cityserviceprovider', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utility.ServiceProvider'])),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['city.City'])),
        ))
        db.send_create_signal(u'utility', ['CityServiceProvider'])

        # Adding model 'ServiceProvider'
        db.create_table(u'utility_serviceprovider', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'utility', ['ServiceProvider'])

        # Adding model 'Statement'
        db.create_table(u'utility_statement', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('processed', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('processed_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='processed_statements', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'utility', ['Statement'])

        # Adding model 'ServiceUtility'
        db.create_table(u'utility_serviceutility', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider', self.gf('django.db.models.fields.related.ForeignKey')(related_name='utilities', to=orm['utility.ServiceProvider'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'utility', ['ServiceUtility'])

        # Adding field 'UtilitySummary.provider'
        db.add_column(u'utility_utilitysummary', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utility.ServiceProvider'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'UtilitySummary.source'
        db.alter_column(u'utility_utilitysummary', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source.Source'], null=True))

        # Changing field 'UtilitySummary.statement'
        db.alter_column(u'utility_utilitysummary', 'statement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utility.Statement']))

    def backwards(self, orm):
        # Deleting model 'CityServiceProvider'
        db.delete_table(u'utility_cityserviceprovider')

        # Deleting model 'ServiceProvider'
        db.delete_table(u'utility_serviceprovider')

        # Deleting model 'Statement'
        db.delete_table(u'utility_statement')

        # Deleting model 'ServiceUtility'
        db.delete_table(u'utility_serviceutility')

        # Deleting field 'UtilitySummary.provider'
        db.delete_column(u'utility_utilitysummary', 'provider_id')


        # User chose to not deal with backwards NULL issues for 'UtilitySummary.source'
        raise RuntimeError("Cannot reverse this migration. 'UtilitySummary.source' and its values cannot be restored.")

        # Changing field 'UtilitySummary.statement'
        db.alter_column(u'utility_utilitysummary', 'statement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utility.StatementUpload']))
    ...
    models = {
        ...
        u'utility.utilitysummary': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'default': "''", 'to': u"orm['source.Source']", 'null': 'True', 'blank': 'True'}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {}),
            'statement': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['utility.Statement']", 'blank': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'default': "'electricity'", 'max_length': '12'}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['building.Unit']"}),
