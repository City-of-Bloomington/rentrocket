...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CityServiceProvider.website'
        db.add_column(u'utility_cityserviceprovider', 'website',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CityServiceProvider.website'
        db.delete_column(u'utility_cityserviceprovider', 'website')
