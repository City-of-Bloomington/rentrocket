...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceProvider.website'
        db.alter_column(u'utility_serviceprovider', 'website', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ServiceProvider.website'
        db.alter_column(u'utility_serviceprovider', 'website', self.gf('django.db.models.fields.CharField')(max_length=255))
