...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UtilitySummary.amount'
        db.alter_column(u'utility_utilitysummary', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'UtilitySummary.cost'
        db.alter_column(u'utility_utilitysummary', 'cost', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UtilitySummary.amount'
        raise RuntimeError("Cannot reverse this migration. 'UtilitySummary.amount' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'UtilitySummary.cost'
        raise RuntimeError("Cannot reverse this migration. 'UtilitySummary.cost' and its values cannot be restored.")
