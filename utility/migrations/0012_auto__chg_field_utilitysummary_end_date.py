...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UtilitySummary.end_date'
        db.alter_column(u'utility_utilitysummary', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UtilitySummary.end_date'
        raise RuntimeError("Cannot reverse this migration. 'UtilitySummary.end_date' and its values cannot be restored.")
