...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Statement.original_filename'
        db.add_column(u'utility_statement', 'original_filename',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Statement.provider'
        db.add_column(u'utility_statement', 'provider',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utility.ServiceProvider'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Statement.vendor'
        db.alter_column(u'utility_statement', 'vendor', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Statement.processed'
        db.alter_column(u'utility_statement', 'processed', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Statement.original_filename'
        db.delete_column(u'utility_statement', 'original_filename')

        # Deleting field 'Statement.provider'
        db.delete_column(u'utility_statement', 'provider_id')


        # Changing field 'Statement.vendor'
        db.alter_column(u'utility_statement', 'vendor', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # User chose to not deal with backwards NULL issues for 'Statement.processed'
        raise RuntimeError("Cannot reverse this migration. 'Statement.processed' and its values cannot be restored.")
