...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StatementUpload.energy_sources'
        db.alter_column(u'utility_statementupload', 'energy_sources', self.gf('jsonfield.fields.JSONField')(null=True))

        # Changing field 'StatementUpload.person_email'
        db.alter_column(u'utility_statementupload', 'person_email', self.gf('django.db.models.fields.EmailField')(max_length=200, null=True))

        # Changing field 'StatementUpload.person'
        db.alter_column(u'utility_statementupload', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['person.Person'], null=True))

        # Changing field 'StatementUpload.move_in'
        db.alter_column(u'utility_statementupload', 'move_in', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'StatementUpload.energy_strategy'
        db.alter_column(u'utility_statementupload', 'energy_strategy', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'StatementUpload.energy_sources'
        db.alter_column(u'utility_statementupload', 'energy_sources', self.gf('jsonfield.fields.JSONField')(default=''))

        # Changing field 'StatementUpload.person_email'
        db.alter_column(u'utility_statementupload', 'person_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=200))

        # User chose to not deal with backwards NULL issues for 'StatementUpload.person'
        raise RuntimeError("Cannot reverse this migration. 'StatementUpload.person' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'StatementUpload.move_in'
        raise RuntimeError("Cannot reverse this migration. 'StatementUpload.move_in' and its values cannot be restored.")

        # Changing field 'StatementUpload.energy_strategy'
        db.alter_column(u'utility_statementupload', 'energy_strategy', self.gf('django.db.models.fields.TextField')(default=''))
