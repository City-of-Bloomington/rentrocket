...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StatementUpload.unit'
        db.delete_column(u'utility_statementupload', 'unit_id')

        # Deleting field 'StatementUpload.building'
        db.delete_column(u'utility_statementupload', 'building_id')

        # Adding field 'StatementUpload.building_address'
        db.add_column(u'utility_statementupload', 'building_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'StatementUpload.unit_number'
        db.add_column(u'utility_statementupload', 'unit_number',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'StatementUpload.unit'
        raise RuntimeError("Cannot reverse this migration. 'StatementUpload.unit' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'StatementUpload.building'
        raise RuntimeError("Cannot reverse this migration. 'StatementUpload.building' and its values cannot be restored.")
        # Deleting field 'StatementUpload.building_address'
        db.delete_column(u'utility_statementupload', 'building_address')

        # Deleting field 'StatementUpload.unit_number'
        db.delete_column(u'utility_statementupload', 'unit_number')
