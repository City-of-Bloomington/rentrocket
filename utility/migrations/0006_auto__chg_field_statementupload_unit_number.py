...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StatementUpload.unit_number'
        db.alter_column(u'utility_statementupload', 'unit_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'StatementUpload.unit_number'
        db.alter_column(u'utility_statementupload', 'unit_number', self.gf('django.db.models.fields.CharField')(default='', max_length=20))
