...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UtilitySummary.vendor'
        db.alter_column(u'utility_utilitysummary', 'vendor', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'UtilitySummary.vendor'
        db.alter_column(u'utility_utilitysummary', 'vendor', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
