...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'building_building', 'energy_score', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Building.energy_score'
        db.alter_column(u'building_building', 'energy_score', self.gf('django.db.models.fields.IntegerField')())
