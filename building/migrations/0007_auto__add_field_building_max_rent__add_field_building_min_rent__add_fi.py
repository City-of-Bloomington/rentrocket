...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Building.max_rent'
        db.add_column(u'building_building', 'max_rent',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.min_rent'
        db.add_column(u'building_building', 'min_rent',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.active_listings'
        db.add_column(u'building_building', 'active_listings',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Building.max_rent_listing'
        db.add_column(u'building_building', 'max_rent_listing',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.min_rent_listing'
        db.add_column(u'building_building', 'min_rent_listing',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.electricity_payee'
        db.add_column(u'building_building', 'electricity_payee',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.gas_payee'
        db.add_column(u'building_building', 'gas_payee',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.water_payee'
        db.add_column(u'building_building', 'water_payee',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.trash_payee'
        db.add_column(u'building_building', 'trash_payee',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.internet_payee'
        db.add_column(u'building_building', 'internet_payee',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.cable_payee'
        db.add_column(u'building_building', 'cable_payee',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.average_electricity'
        db.add_column(u'building_building', 'average_electricity',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.average_gas'
        db.add_column(u'building_building', 'average_gas',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.average_water'
        db.add_column(u'building_building', 'average_water',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.average_trash'
        db.add_column(u'building_building', 'average_trash',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.total_average'
        db.add_column(u'building_building', 'total_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.estimated_total_min'
        db.add_column(u'building_building', 'estimated_total_min',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.estimated_total_max'
        db.add_column(u'building_building', 'estimated_total_max',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.energy_average'
        db.add_column(u'building_building', 'energy_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Building.utility_data_updated'
        db.add_column(u'building_building', 'utility_data_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Building.max_rent'
        db.delete_column(u'building_building', 'max_rent')

        # Deleting field 'Building.min_rent'
        db.delete_column(u'building_building', 'min_rent')

        # Deleting field 'Building.active_listings'
        db.delete_column(u'building_building', 'active_listings')

        # Deleting field 'Building.max_rent_listing'
        db.delete_column(u'building_building', 'max_rent_listing')

        # Deleting field 'Building.min_rent_listing'
        db.delete_column(u'building_building', 'min_rent_listing')

        # Deleting field 'Building.electricity_payee'
        db.delete_column(u'building_building', 'electricity_payee')

        # Deleting field 'Building.gas_payee'
        db.delete_column(u'building_building', 'gas_payee')

        # Deleting field 'Building.water_payee'
        db.delete_column(u'building_building', 'water_payee')

        # Deleting field 'Building.trash_payee'
        db.delete_column(u'building_building', 'trash_payee')

        # Deleting field 'Building.internet_payee'
        db.delete_column(u'building_building', 'internet_payee')

        # Deleting field 'Building.cable_payee'
        db.delete_column(u'building_building', 'cable_payee')

        # Deleting field 'Building.average_electricity'
        db.delete_column(u'building_building', 'average_electricity')

        # Deleting field 'Building.average_gas'
        db.delete_column(u'building_building', 'average_gas')

        # Deleting field 'Building.average_water'
        db.delete_column(u'building_building', 'average_water')

        # Deleting field 'Building.average_trash'
        db.delete_column(u'building_building', 'average_trash')

        # Deleting field 'Building.total_average'
        db.delete_column(u'building_building', 'total_average')

        # Deleting field 'Building.estimated_total_min'
        db.delete_column(u'building_building', 'estimated_total_min')

        # Deleting field 'Building.estimated_total_max'
        db.delete_column(u'building_building', 'estimated_total_max')

        # Deleting field 'Building.energy_average'
        db.delete_column(u'building_building', 'energy_average')

        # Deleting field 'Building.utility_data_updated'
        db.delete_column(u'building_building', 'utility_data_updated')
