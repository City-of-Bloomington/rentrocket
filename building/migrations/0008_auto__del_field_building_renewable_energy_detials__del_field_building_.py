...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Building.renewable_energy_details'
        db.add_column(u'building_building', 'renewable_energy_details',
                      self.gf('jsonfield.fields.JSONField')(default='""'),
                      keep_default=False)

        # Adding field 'Building.garden_details'
        db.add_column(u'building_building', 'garden_details',
                      self.gf('jsonfield.fields.JSONField')(default='""'),
                      keep_default=False)

        # Adding field 'Building.bike_friendly_details'
        db.add_column(u'building_building', 'bike_friendly_details',
                      self.gf('jsonfield.fields.JSONField')(default='""'),
                      keep_default=False)

        # Adding field 'Building.walk_friendly_details'
        db.add_column(u'building_building', 'walk_friendly_details',
                      self.gf('jsonfield.fields.JSONField')(default='""'),
                      keep_default=False)

        # Adding field 'Building.transit_friendly_details'
        db.add_column(u'building_building', 'transit_friendly_details',
                      self.gf('jsonfield.fields.JSONField')(default='""'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Building.renewable_energy_details'
        db.delete_column(u'building_building', 'renewable_energy_details')

        # Deleting field 'Building.garden_details'
        db.delete_column(u'building_building', 'garden_details')

        # Deleting field 'Building.bike_friendly_details'
        db.delete_column(u'building_building', 'bike_friendly_details')

        # Deleting field 'Building.walk_friendly_details'
        db.delete_column(u'building_building', 'walk_friendly_details')

        # Deleting field 'Building.transit_friendly_details'
        db.delete_column(u'building_building', 'transit_friendly_details')
    ...
    models = {
        ...
        u'building.building': {
            ...
            'bike_friendly_details': ('jsonfield.fields.JSONField', [], {'default': '\'""\''}),
            ...
            'garden_details': ('jsonfield.fields.JSONField', [], {'default': '\'""\''}),
            ...
            'renewable_energy_details': ('jsonfield.fields.JSONField', [], {'default': '\'""\''}),
            ...
            'transit_friendly_details': ('jsonfield.fields.JSONField', [], {'default': '\'""\''}),
            ...
            'walk_friendly_details': ('jsonfield.fields.JSONField', [], {'default': '\'""\''}),
