...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.energy_average'
        db.add_column(u'building_unit', 'energy_average',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Unit.energy_score'
        db.add_column(u'building_unit', 'energy_score',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.energy_average'
        db.delete_column(u'building_unit', 'energy_average')

        # Deleting field 'Unit.energy_score'
        db.delete_column(u'building_unit', 'energy_score')
