...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.type'
        db.alter_column(u'building_building', 'type', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'Building.type'
        db.alter_column(u'building_building', 'type', self.gf('django.db.models.fields.CharField')(max_length=12))
