...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.listing_available'
        db.add_column(u'building_unit', 'listing_available',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Unit.listing_rent'
        db.add_column(u'building_unit', 'listing_rent',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'building_listing', (
            ('building', self.gf('django.db.models.fields.related.ForeignKey')(related_name='listings', null=True, to=orm['building.Building'], blank=True)),
        ...
        # Deleting field 'Unit.listing_available'
        db.delete_column(u'building_unit', 'listing_available')

        # Deleting field 'Unit.listing_rent'
        db.delete_column(u'building_unit', 'listing_rent')
