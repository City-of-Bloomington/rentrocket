...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Building.who_pays_electricity'
        db.add_column(u'building_building', 'who_pays_electricity',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.who_pays_gas'
        db.add_column(u'building_building', 'who_pays_gas',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.who_pays_water'
        db.add_column(u'building_building', 'who_pays_water',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.who_pays_trash'
        db.add_column(u'building_building', 'who_pays_trash',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.who_pays_internet'
        db.add_column(u'building_building', 'who_pays_internet',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.who_pays_cable'
        db.add_column(u'building_building', 'who_pays_cable',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20),
                      keep_default=False)

        # Adding field 'Building.energy_saving_features'
        db.add_column(u'building_building', 'energy_saving_features',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Building.who_pays_electricity'
        db.delete_column(u'building_building', 'who_pays_electricity')

        # Deleting field 'Building.who_pays_gas'
        db.delete_column(u'building_building', 'who_pays_gas')

        # Deleting field 'Building.who_pays_water'
        db.delete_column(u'building_building', 'who_pays_water')

        # Deleting field 'Building.who_pays_trash'
        db.delete_column(u'building_building', 'who_pays_trash')

        # Deleting field 'Building.who_pays_internet'
        db.delete_column(u'building_building', 'who_pays_internet')

        # Deleting field 'Building.who_pays_cable'
        db.delete_column(u'building_building', 'who_pays_cable')

        # Deleting field 'Building.energy_saving_features'
        db.delete_column(u'building_building', 'energy_saving_features')
