...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Building.source'
        db.alter_column(u'building_building', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source.Source'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Building.source'
        raise RuntimeError("Cannot reverse this migration. 'Building.source' and its values cannot be restored.")
