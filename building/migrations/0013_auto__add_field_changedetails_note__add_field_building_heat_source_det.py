...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChangeDetails.note'
        db.add_column(u'building_changedetails', 'note',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Building.heat_source_details'
        db.add_column(u'building_building', 'heat_source_details',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Building.heat_source_other'
        db.add_column(u'building_building', 'heat_source_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Unit.status'
        db.add_column(u'building_unit', 'status',
                      self.gf('django.db.models.fields.CharField')(default='unknown', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Unit.visible'
        db.add_column(u'building_unit', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ChangeDetails.note'
        db.delete_column(u'building_changedetails', 'note')

        # Deleting field 'Building.heat_source_details'
        db.delete_column(u'building_building', 'heat_source_details')

        # Deleting field 'Building.heat_source_other'
        db.delete_column(u'building_building', 'heat_source_other')

        # Deleting field 'Unit.status'
        db.delete_column(u'building_unit', 'status')

        # Deleting field 'Unit.visible'
        db.delete_column(u'building_unit', 'visible')
