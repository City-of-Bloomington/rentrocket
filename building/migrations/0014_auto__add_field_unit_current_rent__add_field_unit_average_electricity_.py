...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.average_electricity'
        db.add_column(u'building_unit', 'average_electricity',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Unit.average_gas'
        db.add_column(u'building_unit', 'average_gas',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Unit.average_water'
        db.add_column(u'building_unit', 'average_water',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Unit.average_trash'
        db.add_column(u'building_unit', 'average_trash',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'Unit.tag'
        db.alter_column(u'building_unit', 'tag', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Unit.current_rent'
        db.delete_column(u'building_unit', 'current_rent')

        # Deleting field 'Unit.average_electricity'
        db.delete_column(u'building_unit', 'average_electricity')

        # Deleting field 'Unit.average_gas'
        db.delete_column(u'building_unit', 'average_gas')

        # Deleting field 'Unit.average_water'
        db.delete_column(u'building_unit', 'average_water')

        # Deleting field 'Unit.average_trash'
        db.delete_column(u'building_unit', 'average_trash')


        # Changing field 'Unit.tag'
        db.alter_column(u'building_unit', 'tag', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'building.unit': {
            ...
            'current_rent': ('django.db.models.fields.FloatField', [], {'default': '0'}),
