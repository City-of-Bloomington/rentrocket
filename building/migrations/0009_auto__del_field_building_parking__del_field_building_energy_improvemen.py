...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Building.energy_saving_details'
        db.add_column(u'building_building', 'energy_saving_details',
                      self.gf('rentrocket.helpers.MultiSelectField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Building.energy_saving_other'
        db.add_column(u'building_building', 'energy_saving_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Building.renewable_energy_other'
        db.add_column(u'building_building', 'renewable_energy_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Building.garden_other'
        db.add_column(u'building_building', 'garden_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Building.bike_friendly_other'
        db.add_column(u'building_building', 'bike_friendly_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Building.walk_friendly_other'
        db.add_column(u'building_building', 'walk_friendly_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Building.transit_friendly_other'
        db.add_column(u'building_building', 'transit_friendly_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Building.parking_options'
        db.add_column(u'building_building', 'parking_options',
                      self.gf('rentrocket.helpers.MultiSelectField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Building.pets_options'
        db.add_column(u'building_building', 'pets_options',
                      self.gf('rentrocket.helpers.MultiSelectField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Building.pets_other'
        db.add_column(u'building_building', 'pets_other',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Building.transit_friendly_details'
        db.alter_column(u'building_building', 'transit_friendly_details', self.gf('rentrocket.helpers.MultiSelectField')(max_length=100))

        # Changing field 'Building.renewable_energy_details'
        db.alter_column(u'building_building', 'renewable_energy_details', self.gf('rentrocket.helpers.MultiSelectField')(max_length=100))

        # Changing field 'Building.walk_friendly_details'
        db.alter_column(u'building_building', 'walk_friendly_details', self.gf('rentrocket.helpers.MultiSelectField')(max_length=200))

        # Changing field 'Building.garden_details'
        db.alter_column(u'building_building', 'garden_details', self.gf('rentrocket.helpers.MultiSelectField')(max_length=100))

        # Changing field 'Building.bike_friendly_details'
        db.alter_column(u'building_building', 'bike_friendly_details', self.gf('rentrocket.helpers.MultiSelectField')(max_length=200))

        # Changing field 'Building.pets'
        db.alter_column(u'building_building', 'pets', self.gf('django.db.models.fields.BooleanField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Building.energy_saving_details'
        db.delete_column(u'building_building', 'energy_saving_details')

        # Deleting field 'Building.energy_saving_other'
        db.delete_column(u'building_building', 'energy_saving_other')

        # Deleting field 'Building.renewable_energy_other'
        db.delete_column(u'building_building', 'renewable_energy_other')

        # Deleting field 'Building.garden_other'
        db.delete_column(u'building_building', 'garden_other')

        # Deleting field 'Building.bike_friendly_other'
        db.delete_column(u'building_building', 'bike_friendly_other')

        # Deleting field 'Building.walk_friendly_other'
        db.delete_column(u'building_building', 'walk_friendly_other')

        # Deleting field 'Building.transit_friendly_other'
        db.delete_column(u'building_building', 'transit_friendly_other')

        # Deleting field 'Building.parking_options'
        db.delete_column(u'building_building', 'parking_options')

        # Deleting field 'Building.pets_options'
        db.delete_column(u'building_building', 'pets_options')

        # Deleting field 'Building.pets_other'
        db.delete_column(u'building_building', 'pets_other')


        # Changing field 'Building.transit_friendly_details'
        db.alter_column(u'building_building', 'transit_friendly_details', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Building.renewable_energy_details'
        db.alter_column(u'building_building', 'renewable_energy_details', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Building.walk_friendly_details'
        db.alter_column(u'building_building', 'walk_friendly_details', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Building.garden_details'
        db.alter_column(u'building_building', 'garden_details', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Building.bike_friendly_details'
        db.alter_column(u'building_building', 'bike_friendly_details', self.gf('jsonfield.fields.JSONField')())

        # Changing field 'Building.pets'
        db.alter_column(u'building_building', 'pets', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'building.building': {
            ...
            'cable_payee': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '20'}),
            ...
            'electricity_payee': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '20'}),
            ...
            'gas_payee': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '20'}),
            'geocoder': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'gym': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internet_payee': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '20'}),
            ...
            'trash_payee': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '20'}),
            ...
            'walk_friendly_details': ('rentrocket.helpers.MultiSelectField', [], {'default': "''", 'max_length': '200'}),
            ...
            'water_payee': ('django.db.models.fields.CharField', [], {'default': "'unknown'", 'max_length': '20'}),
