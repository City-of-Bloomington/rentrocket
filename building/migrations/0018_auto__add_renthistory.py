...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RentHistory'
        db.create_table(u'building_renthistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rent', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rent_history', to=orm['building.Unit'])),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'building', ['RentHistory'])


    def backwards(self, orm):
        # Deleting model 'RentHistory'
        db.delete_table(u'building_renthistory')
