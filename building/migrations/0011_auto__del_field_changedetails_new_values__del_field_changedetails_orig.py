...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ChangeDetails.new_values'
        db.delete_column(u'building_changedetails', 'new_values')

        # Deleting field 'ChangeDetails.original_values'
        db.delete_column(u'building_changedetails', 'original_values')

        # Adding field 'ChangeDetails.diffs'
        db.add_column(u'building_changedetails', 'diffs',
                      self.gf('jsonfield.fields.JSONField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'ChangeDetails.ip_address'
        db.add_column(u'building_changedetails', 'ip_address',
                      self.gf('django.db.models.fields.GenericIPAddressField')(default='0.0.0.0', max_length=39),
                      keep_default=False)

        # Adding field 'ChangeDetails.user'
        db.add_column(u'building_changedetails', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ChangeDetails.new_values'
        db.add_column(u'building_changedetails', 'new_values',
                      self.gf('jsonfield.fields.JSONField')(default=''),
                      keep_default=False)

        # Adding field 'ChangeDetails.original_values'
        db.add_column(u'building_changedetails', 'original_values',
                      self.gf('jsonfield.fields.JSONField')(default=''),
                      keep_default=False)

        # Deleting field 'ChangeDetails.diffs'
        db.delete_column(u'building_changedetails', 'diffs')

        # Deleting field 'ChangeDetails.ip_address'
        db.delete_column(u'building_changedetails', 'ip_address')

        # Deleting field 'ChangeDetails.user'
        db.delete_column(u'building_changedetails', 'user_id')
